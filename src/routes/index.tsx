    ...
    <div className="container mx-auto p-8">
      <main className="flex flex-col items-center">
        <div className="w-full max-w-5xl">
          <section className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-16">
            <div className="md:w-3/5 space-y-4 text-center md:text-left">
              ...
              <h2 className="text-2xl font-semibold text-green-700">
                Engenheiro de Telecomunicações IFSC
              </h2>
              ...
              <p className="pt-8 text-gray-700 text-justify">
                Com formação técnica em Telecomunicações e cursando Engenharia de
                Telecomunicações, desenvolvi uma carreira focada em redes e
                sistemas. Minha experiência na Intelbras abrange suporte técnico,
                capacitação e, atualmente, desenvolvimento de produtos para redes
                empresariais, complementada por uma base em projetos de fibra
                óptica.
              </p>
            </div>
          ...
          <section className="mt-16 grid md:grid-cols-2 gap-12 text-gray-700">
            <div>
              ...
              <li>
                  <p className="font-semibold">
                    Analista de Desenvolvimento de Produto - PeD Redes Empresariais, Intelbras
                  </p>
                  <p className="text-sm text-gray-600">2024 - O momento</p>
                </li>
                <li>
                  <p className="font-semibold">
                    Analista de Capacitação em Redes - Suporte Técnico, Intelbras
                  </p>
                  <p className="text-sm text-gray-600">2021 - 2024</p>
                </li>
                <li>
                  <p className="font-semibold">
                    Analista de Redes e Sistemas - Suporte Técnico, Intelbras
                  </p>
