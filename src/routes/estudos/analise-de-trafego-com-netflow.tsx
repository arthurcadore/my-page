...
export const Route = createFileRoute('/estudos/analise-de-trafego-com-netflow')({
  component: AnaliseDeTrafegoComNetflow,
})

function AnaliseDeTrafegoComNetflow() {
  return (
      ...
      <div className="bg-gray-100 shadow-md">
        <div className="container mx-auto flex items-center px-8 py-6">
          ...
          <h1 className="ml-6 text-4xl font-light text-gray-800">
            Análise de Tráfego com Netflow
          </h1>
        </div>
      </div>
